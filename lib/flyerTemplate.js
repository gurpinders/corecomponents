          ...
          (part) => `
            <td style="width:33.33%;padding:8px;vertical-align:top;">
                <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px;">
                    ...
                    ${part.mileage_km != null ? `<span style="display:inline-block;margin-top:6px;height:20px;line-height:20px;background:rgba(96,165,250,0.15);color:#60a5fa;font-size:11px;font-weight:700;padding:0 10px;border-radius:6px;box-sizing:border-box;">${Number(part.mileage_km).toLocaleString()} km</span>` : ""}
                </div>
            </td>
        `,
        )
