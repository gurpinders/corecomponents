function buildEmailBody({ promoMessage, parts, trucks = [] }) {
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
            ...
            <tr>
                <td style="background:#0a0a0a;padding:24px 32px;border-bottom:1px solid rgba(255,255,255,0.1);">
                    <img src="https://ccomponents.ca/logo_white.png" alt="CoreComponents" height="48" style="display:block;height:48px;width:auto;" />
                </td>
            </tr>
...
export function generateCampaignEmail({ promoMessage, parts, trucks = [] }) {
  const body = buildEmailBody({ promoMessage, parts, trucks });
  return `
<!DOCTYPE html>
<html>
...
export function generateCampaignEmailBody({
  promoMessage,
  parts,
  trucks = [],
}) {
  return buildEmailBody({ promoMessage, parts, trucks });
}
